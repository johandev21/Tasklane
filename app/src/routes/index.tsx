        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:py-24">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-base text-muted-foreground sm:text-lg">
              ...
              high-velocity teams. Collaborate live with your Members, track
              work across Lists, and capture every detail.
            </p>
          ...
          <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-3">
            <Card className="border-border">
              <CardHeader>
                ...
                <CardDescription>
                  Structure work through clear horizontal columns and vertical
                  card stacks.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border">
              <CardHeader>
                ...
                <CardDescription>
                  See exactly who is viewing and collaborating on the Board live
                  at any moment.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-border">
              <CardHeader>
                ...
                <CardDescription>
                  Every Card move, Comment, and Label syncs across all screens
                  with zero latency.
                </CardDescription>
              </CardHeader>
            </Card>
